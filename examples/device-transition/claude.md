...
Device transition — the adult plans to interrupt tablet or screen time and move the child to a different activity. The goal is to test whether the transition warning, timing, and wording feel abrupt, unfair, or choice-supportive.
...
Paste a real or representative transcript here.
