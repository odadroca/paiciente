...
Bedtime routine — the adult attempts to move the child through the evening sequence (brushing teeth, changing clothes, getting into bed) within a fixed time window.
