...
### Added
- Tier 2 translations (all 4 languages: PT-PT, ES, FR, DE): `docs/behavior-map.md`, `docs/evidence-map.md`, `docs/table-of-contents.md`, `docs/Technical-Rationale-and-Academic-Positioning.md`, `prompt/design-notes.md`, `references/references.md`, `implementations/claude.md`, `implementations/chatgpt.md`, `implementations/gemini.md`, `implementations/mistral.md` (40 new files).
- Updated `docs/table-of-contents.md` localization section with all locale READMEs and i18n infrastructure files.
